...
abstract final class AppShadows {
  ...
  static const List<BoxShadow> card = [
    ...
    BoxShadow(color: AppColors.glowCardTint, blurRadius: 3, offset: Offset(0, 1)),
  ];

  /// Floating action / concierge triggers, active discovery pills.
  static const List<BoxShadow> glow = [
    BoxShadow(color: AppColors.glowRose, blurRadius: 24, offset: Offset(0, 8), spreadRadius: -4),
  ];

  /// Primary CTA buttons.
  static const List<BoxShadow> cta = [
    BoxShadow(color: AppColors.glowCta, blurRadius: 20, offset: Offset(0, 8)),
  ];
